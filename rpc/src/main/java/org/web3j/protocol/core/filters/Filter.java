...
public abstract class Filter<T> {
  ...
  public void run(ScheduledExecutorService scheduledExecutorService, long blockTime) {
    try {
      ...
      /*
       * We want the filter to be resilient against client issues. On numerous occasions users have
  ...
  private void pollFilter(EthFilter ethFilter) {
    ...
    try {
      ...
      // TODO: This is heinous but there are deep problems here with
      // excessive use of runtimes, and bad error handling
