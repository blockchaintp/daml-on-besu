...
public class NamespaceTest {
  ...
  public void damlHashCheck() {
    assertThat(Namespace.getHash(new byte[] { 0 }))
        .isEqualTo(Bytes.fromHexString("0x6e340b9cffb37a989ca544e6bb780a2c78901d3fb33738768511a30617afa01d"));
  }

  @Test
  public void emptyDamlStateKeyAddressCheck() {
    DamlStateKey key = DamlStateKey.newBuilder().build();
    assertThat(Namespace.makeDamlStateKeyAddress(Raw.StateKey$.MODULE$.apply(key)).toHexString())
        .isEqualTo("0x7500c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
    assertThat(Namespace.makeAddress(Namespace.DamlKeyType.STATE, Raw.StateKey$.MODULE$.apply(key)))
        .isEqualTo(Namespace.makeDamlStateKeyAddress(Raw.StateKey$.MODULE$.apply(key)));
  }
}
