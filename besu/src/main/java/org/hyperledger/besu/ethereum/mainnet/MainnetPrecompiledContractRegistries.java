...
import com.blockchaintp.besu.daml.DamlPublicPrecompiledContract;
...
public abstract class MainnetPrecompiledContractRegistries {
  ...
  static {
    try {
      LOG.debug("Loading class from {}",
          MainnetPrecompiledContractRegistries.class.getProtectionDomain().getCodeSource().getLocation().toURI());
  ...
  static PrecompileContractRegistry appendDamlPublic(
    ...
    LOG.info("Registered DAML public precompiled contract {}", Address.DAML_PUBLIC);
